...
//     let password = "";
//     // let Str = lower + upper + number + symbol;
//     for (let i = 0; i < length; i++ ){
//         let randomMethod = randomFunc[Math.floor(Math.random() * randomFunc.length)];
//         let isChecked = document.getElementById(randomMethod.value).checked;
//         if(isChecked){
//             password = password + randomMethod();
//         }
...
//         pass = pass + str1[Math.floor(Math.random() * str1.length)]
//     }
//     return pass;
// }
...
//         pass = pass + str2[Math.floor(Math.random() * str2.length)]
//     }
//     return pass;  
// }
